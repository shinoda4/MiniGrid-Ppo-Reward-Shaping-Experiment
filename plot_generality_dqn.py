...
# 1. 配置参数 (对应 DQN 通用性实验)
# ==========================================
LOG_DIR = "./logs_generality_dqn_8x8"  # 你的 DQN 实验数据目录
ENV_NAME = "MiniGrid-DoorKey-8x8-v0"
MAX_STEPS = 300000                     # DQN 实验设置的总步数
SMOOTHING_WINDOW = 3000                # 针对 300k 步，3000 比较合适
...
def plot_success_dqn():
    ...
    save_path = "generality_dqn_success_8x8.png"

...
def run_dqn_generality():
    # DQN 通常需要较多的步数来填充 Buffer，建议 300k - 500k
    TOTAL_TIMESTEPS = 300_000 
    SEEDS = [201, 202] # 使用新种子
    LOG_DIR = "./logs_generality_dqn_8x8"
    
    print(f"🔥 开始通用性验证实验 (DQN): MiniGrid-DoorKey-8x8")
